import{j as t}from"./index-BQRZzvVp.js";import{r as d,L as m}from"./react-vendor-B4iHWf4p.js";const c=[{num:1,title:"认识你的第一个靶机",icon:"🔍",theory:`网络安全的第一步是「观察」。每个 Web 页面都有 HTML 源码，开发者经常不小心在源码中留下敏感信息（注释、调试代码、密钥等）。
